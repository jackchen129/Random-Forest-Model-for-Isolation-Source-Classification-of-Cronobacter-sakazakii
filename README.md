# Random Forest Model for Isolation Source Classification of *Cronobacter sakazakii* in the United States

# Binary Isolation Source Classification (Food vs. Clinical)
...
**Citation:**  
This workflow was developed for binary classification of *C. sakazakii* isolates (Food vs. Clinical) based on pan-genomic features.  
